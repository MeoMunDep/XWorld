...
2. **Install Dependencies:**
   ...
   ```bash
   npm install --force user-agents axios colors p-limit https-proxy-agent socks-proxy-agent crypto
   ```
...
```json
{
  ...
  "doTasks": true,
  "referralCode": "bT10Z19pbnZpdGUmYz04Nzg1ODA4",
  "giftCode": "meomundep"
}
```
...
- **Fields Explained:**
  ...
  - `giftCode`: Add a code to receive the reward.
...
- **Help me with your referral** [Referral Link](https://t.me/xworld/app?startapp=bT10Z19pbnZpdGUmYz04Nzg1ODA4)
